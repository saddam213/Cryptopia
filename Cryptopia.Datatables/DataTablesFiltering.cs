...
using System.Linq;
using Cryptopia.Datatables.DynamicLinq;
...
namespace Cryptopia.Datatables
{
	...
	{
		public IQueryable<T> ApplyFiltersAndSort<T>(DataTablesParam dtParameters, IQueryable<T> data,
			DataTablesPropertyInfo[] columns)
		{
